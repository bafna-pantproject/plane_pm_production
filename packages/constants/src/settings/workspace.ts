...
export const WORKSPACE_SETTINGS: Record<TWorkspaceSettingsTabs, TWorkspaceSettingsItem> = {
  ...
  vendors: {
    key: "vendors",
    i18n_label: "workspace_settings.settings.vendors.title",
    href: `/settings/vendors`,
    access: [EUserWorkspaceRoles.ADMIN, EUserWorkspaceRoles.MEMBER],
    highlight: (pathname: string, baseUrl: string) => pathname === `${baseUrl}/settings/vendors/`,
  },
};
